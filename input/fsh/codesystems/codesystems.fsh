...
* #slade-code "Slade Code"
  * ^definition = "A unique identifier assigned by the Slade 360 platform to a practitioner or any other live actor within their network."
* #sha-slade-code "SHA Slade Code"
  * ^definition = "A unique identifier assigned by the Social Health Authority (SHA) in collaboration with the Slade 360 platform for healthcare provider identification and claims processing."
* #kmpdc-registration-number "KMPDC Registration Number"
  * ^definition = "A registration number issued by the Kenya Medical Practitioners and Dentists Council (KMPDC) to medical practitioners and dentists."
* #kmpdc-license-number "KMPDC License Number"
  * ^definition = "A practising license number issued by the Kenya Medical Practitioners and Dentists Council (KMPDC) to medical practitioners and dentists."
* #coc-registration-number "COC Registration Number"
  * ^definition = "A registration number issued by the Clinical Officers Council (COC) to clinical officers."
* #nck-registration-number "NCK Registration Number"
  * ^definition = "A registration number issued by the Nursing Council of Kenya (NCK) to nurses and midwives."
* #ppb-registration-number "PPB Registration Number"
  * ^definition = "A registration number issued by the Pharmacy and Poisons Board (PPB) to pharmacists and pharmaceutical technologists."
...
// and how the draw went. Concepts that already had a home are NOT repeated here —
// eight of the nine sample types are HL7 v2-0487 concepts and a visibly
// haemolysed sample is v2-0493 #HEM, so only the gaps are coded locally.
//
// Container is deliberately its own axis rather than an additive. HL7 v2-0371
// codes the additive a tube carries (EDTK, SST, C32, NAF, HEPL, AMIES) and binds
// at Specimen.processing.additive; these codes name the physical container the
// sample is collected into, which is what the collection screen offers and what
// a plain tube, a sterile universal container and the two blood culture bottles
// need — none of which an additive code can express.
// ─────────────────────────────────────────────────────────────────────────────
CodeSystem: SGHISpecimenCollectionCodeSystem
Id: specimen-collection-codesystem
Title: "SGHI Specimen Collection Code System"
Description: "A code system enumerating the specimen collection concepts with no home in HL7 terminology: the containers a sample is collected into, and how the draw itself went."
* ^status = #active
* ^experimental = false
* ^content = #complete
* ^caseSensitive = true

// Sample type — the one of the nine v2-0487 has no concept for.
* #swab "Swab" "Material collected on a swab, whatever the site. The site is recorded on the specimen, not in this code."

// Container. The cap colour is part of the display because it is how the
// container is asked for and handed over at the bench; HL7's container-cap has
// no gold and no purple, so the colour is not coded as a separate axis.
* #edta-tube "EDTA tube (purple top)" "Tube carrying potassium EDTA anticoagulant, used for haematology."
* #sst-gel-tube "SST gel tube (gold top)" "Serum separator tube with a polymer gel barrier, used for most chemistry and serology."
* #plain-tube "Plain tube (red top)" "Tube with no additive, letting the sample clot for serum."
* #citrate-tube "Sodium citrate tube (blue top)" "Tube carrying buffered sodium citrate at a fixed blood-to-additive ratio, used for coagulation. Sensitive to a short draw."
* #fluoride-oxalate-tube "Fluoride oxalate tube (grey top)" "Tube carrying sodium fluoride and potassium oxalate, which halts glycolysis for glucose and lactate."
* #lithium-heparin-tube "Lithium heparin tube (green top)" "Tube carrying lithium heparin anticoagulant, used for plasma chemistry."
* #blood-culture-aerobic "Blood culture bottle (aerobic)" "Culture bottle for organisms that grow in the presence of oxygen."
* #blood-culture-anaerobic "Blood culture bottle (anaerobic)" "Culture bottle for organisms that grow in the absence of oxygen."
* #sterile-universal-container "Sterile universal container" "A sterile screw-top pot for urine, stool, sputum and other unpreserved samples."
* #formalin-pot "Formalin pot (10% neutral buffered)" "Pot pre-filled with 10% neutral buffered formalin, for tissue going to histopathology."
* #cytology-fixative-pot "Cytology fixative pot" "Pot pre-filled with cytology fixative, for samples going to cytology."
* #amies-swab "Transport swab (Amies medium)" "A swab in Amies transport medium, keeping organisms viable on the way to microbiology."

// Condition at collection — how the draw went, recorded by whoever took it.
// Haemolysis is not here: it is v2-0493 #HEM, the code Specimen.condition is
// already bound to.
