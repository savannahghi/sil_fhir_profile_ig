...
* group[0].element[4].code = #166675
* group[0].element[4].display = "Average Risk"
* group[0].element[4].target[0].code = #moderate
* group[0].element[4].target[0].display = "Moderate likelihood"
